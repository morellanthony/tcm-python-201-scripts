...
# MSDN api function calls ---> GetWindowTextLengethA, GetWindowTextA, GetKeyState, 
# GetKeyboardState, ToAscii, CallNextHookEx, SetWindowsHookExA, GetMessageA
...
# Verify a process is being foregrounded.
